...
##### This is only the first step! untill the production of the fake reads for the alignment
#####
...
$TASSEL -Xmx12g -fork1 -FastqToTagCountPlugin -i fastq -k barcodes_bras.csv -e cviaii -s 350000000 -o tagCounts -endPlugin -runfork1|tee logs_part1.txt
